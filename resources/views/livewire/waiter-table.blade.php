<div wire:poll.30000ms>
    ...
    <div class="grid grid-cols-3 gap-4 mt-2 text-white">
        @foreach ($tables as $table)
            <div tabindex="0" wire:keydown.enter="viewTable({{ $table }})" class="focus:ring-4 ring-offset-2 ring-offset-slate-50 flex flex-col relative justify-between p-4 rounded-lg {{ TableStatus::from($table->status)->color() }} shadow-lg w-full cursor-pointer" wire:click="viewTable({{ $table }})">
